...
<script>
    ...
    var mymap;
            ...
            function onLoad() {
                 mymap = L.map('mapid').setView([16.904276, 121.798675], 9);

                //var geojsonLayer = new L.GeoJSON.AJAX('<?php echo e(URL::asset('wlmap')); ?>');       

                L.tileLayer("<?php echo e(URL::asset('img/maps/offline/{z}/{x}/{y}.png')); ?>",
   ...
   var icnodata = L.icon({
    ...
    //##################################ICONS##################################################
             $.get("<?php echo e(URL::asset('wlmap')); ?>").done(function(e){
...
var grydrpv = L.icon({
        ...
        iconAnchor: [5, 20], // horizontal puis vertical
             ...
             $.get("<?php echo e(URL::asset('map')); ?>").done(function(e){
                //console.log(JSON.parse(e));
                var alldata = JSON.parse(e);
