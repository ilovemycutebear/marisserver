            ...
            <div class="input-group input-group-sm" style="width: 150px;">
                ...
                <select name="connection" id="connections" class="form-control pull-right" style="margin-right: 10px;">
                    ...
                    <?php if(!empty($connections['dbs'])): ?>
                        <optgroup label="dbs">
                        <?php $__currentLoopData = $connections['dbs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $db): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    ...
                    <?php if(!empty($connections['redis'])): ?>
                        <optgroup label="redis">
                            <?php $__currentLoopData = $connections['redis']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $redis): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
