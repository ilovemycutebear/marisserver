...
<div class="box box-primary">
    ...
    <div class="box-footer with-border">
        ...
        <div style="margin-bottom: 10px;">
            ...
            <?php $__currentLoopData = $commands['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $command): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = $command; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            ...
            <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = $commands['others']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <li><a href="#" class="loaded-command"><?php echo e($item); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </ul>
            </div>
