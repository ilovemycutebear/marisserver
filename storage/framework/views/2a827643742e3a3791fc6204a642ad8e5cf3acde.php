                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                 <select class="form-control" id="sel1" name="sitename">
                                    <?php $__currentLoopData = $siteinfocombo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siteinfos): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
function drawRnChart() {
    ...
    $.post('<?php echo e(URL::asset('hstrycombo/chartrn')); ?>',{ 
...
function drawWlhart() {
    ...
    $.post('<?php echo e(URL::asset('hstrycombo/chartlvl')); ?>',{ 
...
function drawDsChart() {
    ...
    $.post('<?php echo e(URL::asset('hstrycombo/chartdsc')); ?>',{ 
