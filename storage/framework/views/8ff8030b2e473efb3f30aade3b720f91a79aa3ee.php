        ...
        <form method="post" action="<?php echo e($action); ?>" id="scaffold" pjax-container>
            ...
            <div class="box-body">
                ...
                <table class="table table-hover" id="table-fields">
                    ...
                    <?php if(old('fields')): ?>
                        <?php $__currentLoopData = old('fields'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $field): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select style="width: 200px" name="fields[<?php echo e($index); ?>][type]">
                                        <?php $__currentLoopData = $dbTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
