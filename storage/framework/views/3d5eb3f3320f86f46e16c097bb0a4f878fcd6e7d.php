...
<!--#################################################DIVIDER######################################################################-->
 <!--*********TABLES**************-->
       <div id="table_latest" class="alert-info text-center"><h1>RAIN</h1></div>
...
<!--#################################################DIVIDER######################################################################-->
 <!--*********TABLES**************-->
       <div id="table_latest" class="alert-info text-center"><h1>WATER LEVEL</h1></div>
...
function WLcalltable(){
    console.log ('<?php echo e(URL::asset('wldata')); ?>'+"/"+clckr);
...
function RNcalltable(){
    console.log ('<?php echo e(URL::asset('data')); ?>'+"/"+clckr);
    $('#users-table').DataTable({
        destroy: true,
