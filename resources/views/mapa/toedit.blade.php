...
<div id='toggle' style='display:none;'>
  <button onclick="togglePoints();">RAIN</button>
</div>
...
@push('map-scripts')
<script>
  var data1 = '{{URL::asset('map')}}';
  var data2 = '{{URL::asset('wlmap')}}';
var clusterGroup = new L.layerGroup();
var map = L.map('map').setView([16.871656, 121.135942], 9);
